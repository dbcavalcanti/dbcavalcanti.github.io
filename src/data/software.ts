...
export const software: SoftwareEntry[] = [
  ...
  },
  {
    ...
    description:
      "Experience collaborating with and working in GeMA, developed at Tecgraf, in the context of multiphysics simulation and computational mechanics. This entry reflects research use and contribution experience, not software ownership.",
